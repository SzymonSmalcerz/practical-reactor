...
public class c2_TransformingSequence extends TransformingSequenceBase {
    ...
    public void transforming_sequence_2() {
        ...
        Function<Flux<Integer>, Flux<String>> transformingFluxFunction =
                flux -> flux.map(i -> i > 0 ? ">" : (i == 0 ? "=" : "<"));
        Flux<String> resultSequence = numbersFlux.transform(transformingFluxFunction);
